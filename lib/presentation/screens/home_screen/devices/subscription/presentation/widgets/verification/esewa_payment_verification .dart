...
class EsewaPaymentVerification extends StatelessWidget {
  final EsewaInitPaymentModel esewa;

  const EsewaPaymentVerification({super.key, required this.esewa});

  @override
  Widget build(BuildContext context) {
    final String encodedData = encodeEsewaPayment(esewa);
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => locator.get<SubscriptionCubit>()..esewaPaymentVerification(encodedData),
                          ...
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(
                                  fontWeight: FontWeight.w600, fontSize: 16, color: Color.fromARGB(255, 0, 74, 2)),
                            ),
                          ),
                        ],
                      ),
  ...
  String encodeEsewaPayment(EsewaInitPaymentModel esewa) {
    final String jsonString = jsonEncode(esewa.toJson());
